...
describe('chunkCode', () => {
    it('should chunk code correctly under a max size limit', () => {
        ...
        assert(reconstructedCode === codeString1, 'Chunks do not maintain code integrity');
    });
});